 ...
 <head>
    ...
    <div style="position :absolute;top:20px;left:40px">
        <p><h2>MY<br/> 
                GYM 
               <br/></h2></p></div>
          <div style="position: absolute ;left:  200px; top: 20px;"><img  src="header2.jpg" height="200" width="750"
                          /> </div>
          <div style="position:absolute;top:37%;left:35%">
      <link href="http://fonts.googleapis.com/css?family=Oswald:400,300" rel="stylesheet" type="text/css" />         
  
      <link href="style.css" rel="stylesheet" type="text/css" media="screen" />
      <a href="index.php" style="text-decoration: none;color: black;font:serif;font-weight: bold;  ">Home |</a>
...
<form method="post" action="coashData.php">
...
<tr>
    <td><b style="color: black"> Please insert your User Name</b></td>
		...
		<td><b style="color: black">User</b></td>
			<td>
				<input id="tUserName" name="tUserName" type="text"maxlength="10"/>
			</td>	
		</tr>
		<tr>
		<td><b style="color: black">Password</b></td>
			<td>
				<input id="tPass1" name="tPass1" type="password" maxlength="8"/>
			</td>	
		</tr>
